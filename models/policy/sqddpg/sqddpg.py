...
from models.policy.sqddpg.model import Model
...
class SQDDPG(Model):
    ...
    def __init__(self, args, n_agents, n_action, obs_dim, target_net=None):
        super(SQDDPG, self).__init__(args, n_agents, n_action, obs_dim)
